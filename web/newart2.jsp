...
<%
	...
	boolean keepAndLink = request.getParameter("keepAndLink") == null;
	...
	if (iconURL == null || iconURL.length() == 0) {
		...
		.getRealPath("aimg"), iconURL, keepAndLink);
	}
	if ( uploadedFileStream!=null ){
		img = new NImage(getServletContext(), application
				.getRealPath("aimg"), uploadedFileStream, uploadedName, keepAndLink);		
	}
...
<p></p>
<form action="newart2.jsp" method="post" ENCTYPE="multipart/form-data">
<%
